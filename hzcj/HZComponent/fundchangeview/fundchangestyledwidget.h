...
*********************************************************************/
#ifndef FundChangeStyledWidget_H
#define FundChangeStyledWidget_H
#include "basewidget.h"


class FundChangeStyledWidget:public BaseWidget
{
    Q_OBJECT
...
public:
    explicit FundChangeStyledWidget(QWidget *parent = nullptr);
    //设置上涨颜色
...
#endif // FundChangeStyledWidget_H
